 ...
 */
package F.com.anup.algorithms.datastructures.hashtable;



//https://www.youtube.com/watch?v=T9gct6Dx-jo    >>>>>>>>>>>>>>2.59 min mark




//normalizeIndex = bucketIndex 
...
// since LinkedList we can use java remove and add for bucket
//-no custom code for this add and remove
//to get keys and Values we use two for loops :::
//1 for bucket:table  2. entry:buckt
//normalizeIndex >>>>>> Converts a hash value to an index>>> gives bucketIndex
...
class Entry<K, V> {
  ...
  public Entry(K key, V value) {
    this.key = key;
    this.value = value;
    this.hash = key.hashCode();//##########hash of Key
  }
...
//##############################################
//##############################################
  private LinkedList<Entry<K, V>>[] table;//#########array of linked list#######
//###################################################
//##############################################
//##############################################
//##############################################
...
//##############################################
  ...
  private int normalizeIndex(int keyHashValue) {
    return (keyHashValue & 0x7FFFFFFF) % capacity;
  }
...
//##############################################
  ...
  public V insert(K key, V value) {
    ...
    int bucketIndex = normalizeIndex(newEntry.hash);////bktIndx=== normalizeIndx
  ...
  //BUCKet means whatever ds you are uisng in that index -video5.16>>>>>>>>>>>
